...
| M1.6 | [Lucene source sweep](m1-6-lucene-sweep.md) | Read the port file by file against Lucene 10.5.0; find parity gaps and un-done optimisations, and measure each component against Lucene's own number | M–L | ✅ **delivered — decode kernels now 1.6×–2.2× *faster* than Lucene, segmented recall 13→0 mismatches, end-to-end median 0.15×→0.34×, M1 gate still FAIL. Found reader open at 135× Lucene: the term dictionary is materialized at open** |
